...
export function getMonthlyDetail(month: number, dayMasterElement: number, yearFortuneStars: number): {
  ...
  const moneyByRel = [
    '이번 달은 지출 관리가 핵심입니다. 충동구매를 피하고 가계부를 써보세요.',
    '부수입이 생길 수 있는 달입니다. 소규모 투자나 부업에 눈을 돌려보세요.',
    '재물운이 좋은 달! 기다리던 돈이 들어오거나 좋은 거래가 성사될 수 있습니다.',
    '예상치 못한 지출에 대비하세요. 자동차 수리, 의료비 등이 발생할 수 있습니다.',
    '저축과 자기투자에 집중하세요. 이번 달 모은 돈이 나중에 큰 도움이 됩니다.',
  ]

  const loveByRel = [
    '연인이나 가까운 사람과 의견 충돌이 있을 수 있어요. 양보가 필요한 달입니다.',
    '새로운 만남의 기회가 많은 달! 적극적으로 사교 활동에 참여하세요.',
    '로맨틱한 이벤트가 생길 수 있는 달. 고백이나 프로포즈에 좋은 시기입니다.',
    '관계에서 진지한 대화가 필요한 달입니다. 미루던 이야기를 꺼내보세요.',
    '혼자만의 시간이 필요한 달. 자신을 돌보면 관계도 좋아집니다.',
  ]

  const warningByRel = [
    '가까운 사람과의 금전 거래를 피하세요.',
    '과한 자신감으로 실수할 수 있어요. 겸손하게 행동하세요.',
    '사기나 과대광고에 주의하세요. 너무 좋은 조건은 의심하세요.',
    '건강검진을 미루지 마세요. 작은 증상도 무시하지 마세요.',
    '중요한 결정은 이번 달에 하지 마세요. 다음 달까지 기다리세요.',
  ]
