...
// ── 올해 운세 (세운) 상세 해석 ──
export function getYearFortune(dayMasterElement: number, currentYear: number): {
  title: string; description: string; stars: number; advice: string;
  money: string; love: string; career: string; health: string; warning: string;
} {
  ...
  const fortunes = [
    {
      ...
      money: '수입은 있지만 지출도 늘어납니다. 예상치 못한 경조사비나 교제비가 발생할 수 있어요. 상반기에 큰 지출이 예상되니 미리 준비하세요. 투자보다는 저축 중심으로 가는 것이 현명합니다.',
      love: '새로운 인연이 가까이에 있지만, 경쟁자도 함께 나타날 수 있어요. 연인이 있다면 관계에 소홀해지기 쉬운 시기입니다. 데이트 시간을 의식적으로 확보하세요.',
      career: '직장에서 동료와의 경쟁이 심해집니다. 하지만 이것이 당신의 실력을 한 단계 끌어올리는 계기가 됩니다. 이직보다는 현 직장에서 인정받는 것에 집중하세요.',
      health: '과로로 인한 피로 누적에 주의하세요. 올해는 특히 수면 관리가 중요합니다. 무리한 운동보다 규칙적인 생활 리듬을 유지하세요.',
      warning: '가까운 사람과의 금전 거래는 반드시 피하세요. 보증을 서거나 돈을 빌려주면 관계가 틀어질 수 있습니다.',
    },
    {
      ...
      money: '새로운 수입원이 생길 가능성이 높습니다. 부업이나 프리랜서 활동에서 예상 외의 수익이 발생할 수 있어요. 하반기에 목돈이 들어올 기회가 있으니 준비하세요.',
      love: '당신의 매력이 극대화되는 해! 솔로라면 자연스럽게 이성의 관심을 끌게 됩니다. 커플이라면 함께 새로운 경험(여행, 취미)을 하면 관계가 더욱 깊어져요.',
      career: '이직, 창업, 새 프로젝트 모두 좋은 결과를 기대할 수 있습니다. 특히 콘텐츠, 교육, 예술 분야에서 기회가 옵니다. 적극적으로 자기 PR을 하세요.',
      health: '정신적 에너지 소모가 많은 해입니다. 번아웃에 주의하고 주기적인 휴식을 꼭 챙기세요. 소화기 관련 불편이 생길 수 있으니 식사를 거르지 마세요.',
      warning: '말실수에 주의하세요. 올해는 표현력이 좋아지지만 그만큼 실언할 가능성도 높습니다. 중요한 자리에서는 한 번 더 생각하고 말하세요.',
    },
    {
      title: '재성운 — 재물과 풍요의 해',
      ...
      money: '올해 최고의 재물운! 연봉 상승, 보너스, 투자 수익 등 여러 경로로 돈이 들어옵니다. 특히 3~5월, 9~11월이 재물이 모이는 시기입니다. 부동산이나 주식에서 좋은 기회가 올 수 있지만, 빚을 내서 투자하는 것은 절대 금물.',
      love: '경제적 여유가 생기면서 연애에도 자신감이 붙습니다. 솔로라면 소개팅이나 모임에서 좋은 인연을 만날 확률이 높아요. 다만 돈으로 사랑을 살 수는 없다는 것을 기억하세요.',
      career: '성과급, 진급, 새로운 비즈니스 제안 등 경제적으로 좋은 소식이 들려옵니다. 프리랜서라면 대형 계약이 성사될 수 있어요. 자기 가치를 제대로 인정받는 해입니다.',
      health: '먹고 마시는 것에 주의가 필요합니다. 사교 활동이 늘면서 체중 증가나 간 건강에 적신호가 올 수 있어요. 정기 건강검진을 꼭 받으세요.',
      warning: '과욕에 주의하세요. 돈이 잘 들어온다고 무리하게 투자하거나 사업을 확장하면 하반기에 큰 손실이 올 수 있습니다. 현금 유동성을 항상 확보해두세요.',
    },
    {
      title: '관성운 — 변화와 도전의 해',
      ...
      money: '안정적이지만 큰 수익은 기대하기 어렵습니다. 예상치 못한 지출(세금, 벌금, 수리비 등)이 발생할 수 있으니 비상금을 준비해두세요. 상반기보다 하반기 재물운이 나아집니다.',
      love: '관계에서 진지한 결정을 해야 하는 시기입니다. 결혼을 고민하거나, 관계를 정리해야 할 수 있어요. 감정보다 현실적인 판단이 필요합니다. 솔로라면 직장이나 공적 모임에서 인연을 만날 수 있습니다.',
      career: '직장에서 새로운 책임을 맡거나 부서 이동이 있을 수 있습니다. 승진 기회가 오지만 그만큼 압박도 커집니다. 윗사람과의 관계 관리가 올해 성공의 열쇠입니다.',
      health: '스트레스성 질환에 주의하세요. 두통, 불면, 소화 불량 등이 나타날 수 있습니다. 주말에는 반드시 쉬고, 평일 저녁에 가벼운 운동을 하세요.',
      warning: '법적 분쟁이나 계약 관련 문제에 특히 조심하세요. 서류는 꼼꼼히 확인하고, 구두 약속만 믿지 마세요. 교통사고에도 주의가 필요합니다.',
    },
    {
      ...
      money: '급격한 수입 증가보다는 꾸준한 성장이 예상됩니다. 자기계발에 투자한 돈은 3배로 돌아옵니다. 부동산보다 자기 자신에게 투자하는 것이 최고의 재테크입니다.',
      love: '지적인 매력이 빛나는 해! 스터디, 세미나, 강의 등에서 좋은 인연을 만날 수 있어요. 기존 연인과는 서로의 성장을 응원하는 관계가 되면 더욱 단단해집니다.',
      career: '새로운 자격증이나 기술을 습득하면 연말에 큰 기회가 옵니다. 상사나 멘토의 도움이 있을 수 있으니 인간관계를 소중히 하세요. 전문성을 높이는 것이 최우선입니다.',
      health: '머리를 많이 쓰는 해라 정신적 피로가 쌓입니다. 충분한 수면(7시간 이상)이 필수이며, 눈 건강에도 주의하세요. 명상이나 요가가 큰 도움이 됩니다.',
      warning: '너무 이론에만 빠지지 마세요. 공부만 하고 실행하지 않으면 기회를 놓칩니다. 또한 보증이나 계약서에 사인할 때는 반드시 전문가와 상의하세요.',
    },
  ]
