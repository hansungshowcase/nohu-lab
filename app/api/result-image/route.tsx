...
const catMeta = [
  { key: 'f', label: '재정 준비도', letter: 'F', color: '#ea580c' },
...
export async function GET(request: Request) {
  ...
  const gradeColor = (p: number) => p >= 80 ? '#ea580c' : p >= 60 ? '#2563eb' : p >= 40 ? '#ca8a04' : '#dc2626'
      ...
      <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px' }}>
              ...
              <span style={{
                ...
                color: '#fff',
                backgroundColor: total >= 61 ? '#ea580c' : total >= 37 ? '#ca8a04' : '#dc2626',
              }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', padding: '28px 48px', gap: '16px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '4px' }}>
            <div style={{ width: '4px', height: '22px', borderRadius: '2px', backgroundColor: '#9a3412' }} />
